...
-- insert dummy data  for the above schema uuid for riders customer and vendor should be unique and id is always UUID

INSERT INTO public.authentications (user_id, email, password, role, created_at, updated_at) 
VALUES () 
